...
contract VRFCoordinatorTestV2_5 is VRFOld, SubscriptionAPI, IVRFCoordinatorV2Plus {
    ...
    function _getRandomnessFromProof(Proof memory proof, VRFTypes.RequestCommitmentV2Plus memory rc)
        internal
        view
    ...
    */
    function fulfillRandomWords(Proof memory proof, VRFTypes.RequestCommitmentV2Plus memory rc, bool onlyPremium)
        external
        nonReentrant
