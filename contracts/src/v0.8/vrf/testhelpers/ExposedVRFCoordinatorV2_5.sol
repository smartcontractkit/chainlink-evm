...
contract ExposedVRFCoordinatorV2_5 is VRFCoordinatorV2_5 {
    ...
    function getRandomnessFromProofExternal(Proof calldata proof, VRFTypes.RequestCommitmentV2Plus calldata rc)
        external
        view
    ...
    function calculatePaymentAmount(uint256 startGas, uint256 weiPerUnitGas, bool nativePayment, bool onlyPremium)
        external
        returns (uint96, bool)
    {
