...
contract MaliciousConsumer is Chainlinked {
  ...
  function cancelRequestOnFulfill(
    bytes32 _requestId,
    bytes32
  ) public {
  ...
  function doesNothing(
    bytes32,
    bytes32
  ) public pure {} // solhint-disable-line no-empty-blocks
}
