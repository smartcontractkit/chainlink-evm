...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.7.1-0.20250605161733-bc72ed95ed5c
	github.com/smartcontractkit/chainlink-framework/capabilities v0.0.0-20250605161945-e139f71c341e
