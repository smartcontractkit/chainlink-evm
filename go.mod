...
require (
	...
	github.com/smartcontractkit/chain-selectors v1.0.62-0.20250630171319-46d82b295534
	github.com/smartcontractkit/chainlink-common v0.7.1-0.20250630165811-f4dfbf72d4c5
