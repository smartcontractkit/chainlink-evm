...
func (_m *Workflow) ForwarderAddress() *ethkey.EIP55Address {
	ret := _m.Called()
...
func (_m *Workflow) FromAddress() *ethkey.EIP55Address {
	ret := _m.Called()
...
func (_c *Workflow_FromAddress_Call) Return(_a0 *ethkey.EIP55Address) *Workflow_FromAddress_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Workflow_FromAddress_Call) RunAndReturn(run func() *ethkey.EIP55Address) *Workflow_FromAddress_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Workflow) TxAcceptanceState() *types.TransactionStatus {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() *types.TransactionStatus); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *Workflow_TxAcceptanceState_Call) Return(_a0 *types.TransactionStatus) *Workflow_TxAcceptanceState_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Workflow_TxAcceptanceState_Call) RunAndReturn(run func() *types.TransactionStatus) *Workflow_TxAcceptanceState_Call {
	_c.Call.Return(run)
	return _c
}
