...
type FeedUpdated struct {
	...
	BenchmarkVal float64 `protobuf:"fixed64,6,opt,name=benchmark_val,json=benchmarkVal,proto3" json:"benchmark_val,omitempty"`
...
const file_feed_updated_proto_rawDesc = "" +
	"\n" +
	"\x12feed_updated.proto\x12\x1bdatafeeds.on_chain.registry\"\xfa\t\n" +
	...
	"\x06bundle\x18\x04 \x01(\fR\x06bundle\x12\x16\n" +
	"\x06report\x18\x05 \x01(\fR\x06report\x12#\n" +
	"\rbenchmark_val\x18\x06 \x01(\x01R\fbenchmarkVal\x12\x1d\n" +
	"\n" +
	"block_hash\x18\a \x01(\tR\tblockHash\x12!\n" +
	"\fblock_height\x18\b \x01(\tR\vblockHeight\x12'\n" +
	"\x0fblock_timestamp\x18\t \x01(\x04R\x0eblockTimestamp\x12\x13\n" +
	"\x05tx_id\x18\n" +
