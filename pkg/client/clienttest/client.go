...
func (_c *Client_TransactionByHash_Call) Return(_a0 *coretypes.Transaction, _a1 bool, _a2 error) *Client_TransactionByHash_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}
...
func (_m *Client) TransactionByHashWithOpts(ctx context.Context, txHash common.Hash, opts types.TransactionByHashOpts) (*coretypes.Transaction, bool, error) {
	...
	var r1 bool
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Hash, types.TransactionByHashOpts) (*coretypes.Transaction, bool, error)); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, common.Hash, types.TransactionByHashOpts) bool); ok {
		r1 = rf(ctx, txHash, opts)
	} else {
		r1 = ret.Get(1).(bool)
	}

	if rf, ok := ret.Get(2).(func(context.Context, common.Hash, types.TransactionByHashOpts) error); ok {
		r2 = rf(ctx, txHash, opts)
	} else {
		r2 = ret.Error(2)
	}
...
func (_c *Client_TransactionByHashWithOpts_Call) Return(_a0 *coretypes.Transaction, _a1 bool, _a2 error) *Client_TransactionByHashWithOpts_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *Client_TransactionByHashWithOpts_Call) RunAndReturn(run func(context.Context, common.Hash, types.TransactionByHashOpts) (*coretypes.Transaction, bool, error)) *Client_TransactionByHashWithOpts_Call {
	_c.Call.Return(run)
	return _c
}
