...
func TestORM_TransactionsWithAttempts(t *testing.T) {
	...
	txStore := testutils.NewTestTxStore(t, db)
	ctx := tests.Context(t)

	fromAddress := testutils.NewAddress()

	testutils.MustInsertConfirmedEthTxWithLegacyAttempt(t, txStore, 0, 1, fromAddress)        // tx1
	tx2 := testutils.MustInsertConfirmedEthTxWithLegacyAttempt(t, txStore, 1, 2, fromAddress) // tx2

	// add 2nd attempt to tx2
	blockNum := int64(3)
	attempt := testutils.NewLegacyEthTxAttempt(t, tx2.ID)
...
func TestORM(t *testing.T) {
	...
	t.Run("InsertTxAttempt", func(t *testing.T) {
		...
		testutils.AssertCount(t, db, "evm.tx_attempts", 2)
	})
	var r txmgr.Receipt
	t.Run("InsertReceipt", func(t *testing.T) {
		...
		testutils.AssertCount(t, db, "evm.receipts", 1)
	})
...
func TestORM_FindTxAttemptConfirmedByTxIDs(t *testing.T) {
	...
	tx1 := testutils.MustInsertConfirmedEthTxWithLegacyAttempt(t, orm, 0, 1, fromAddress) // tx1
	tx2 := testutils.MustInsertConfirmedEthTxWithLegacyAttempt(t, orm, 1, 2, fromAddress) // tx2
	...
	testutils.MustInsertUnconfirmedEthTx(t, orm, 3, fromAddress)                           // tx4
	testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, orm, 4, fromAddress) // tx5
...
func TestORM_FindTxAttemptsRequiringResend(t *testing.T) {
	...
	e1 := testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 1, fromAddress, time.Unix(1616509200, 0))
	e3 := mustInsertUnconfirmedEthTxWithBroadcastDynamicFeeAttempt(t, txStore, 3, fromAddress, time.Unix(1616509400, 0))
	e0 := testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 0, fromAddress, time.Unix(1616509100, 0))
	e2 := testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 2, fromAddress, time.Unix(1616509300, 0))
	...
	attempt4_2 := testutils.NewDynamicFeeEthTxAttempt(t, etxs[3].ID)
	...
	attempt4_4 := testutils.NewDynamicFeeEthTxAttempt(t, etxs[3].ID)
	...
	attempt4_3 := testutils.NewDynamicFeeEthTxAttempt(t, etxs[3].ID)
...
func TestORM_SetBroadcastBeforeBlockNum(t *testing.T) {
	...
	fromAddress := testutils.NewAddress()
	etx := testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 0, fromAddress)
	...
	t.Run("only updates evm.tx_attempts for the current chain", func(t *testing.T) {
		etxThisChain := testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 1, fromAddress, cfg.EVM().ChainID())
		etxOtherChain := testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 0, fromAddress, testutils.SimulatedChainID)
...
func TestORM_SaveFetchedReceipts(t *testing.T) {
	...
	tx1 := testutils.MustInsertConfirmedEthTxWithLegacyAttempt(t, txStore, 0, 100, fromAddress)
...
func TestORM_PreloadTxes(t *testing.T) {
	...
	t.Run("loads eth transaction", func(t *testing.T) {
		...
		etx := testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, int64(7), fromAddress)
...
func TestORM_FindTxesPendingCallback(t *testing.T) {
	...
	etx1 := testutils.MustInsertConfirmedEthTxWithLegacyAttempt(t, txStore, 3, 1, fromAddress)
	...
	etx2 := testutils.MustInsertConfirmedEthTxWithLegacyAttempt(t, txStore, 4, 1, fromAddress)
	...
	etx3 := testutils.MustInsertConfirmedEthTxWithLegacyAttempt(t, txStore, 5, 1, fromAddress)
	testutils.MustExec(t, db, `UPDATE evm.txes SET meta='{"FailOnRevert": false}'`)
	...
	etx4 := testutils.MustInsertConfirmedEthTxWithLegacyAttempt(t, txStore, 6, 1, fromAddress)
	...
	etx5 := testutils.MustInsertConfirmedEthTxWithLegacyAttempt(t, txStore, 7, 1, fromAddress)
...
func TestORM_FindTxWithSequence(t *testing.T) {
	...
	t.Run("returns transaction if it exists", func(t *testing.T) {
		etx := testutils.MustInsertConfirmedEthTxWithLegacyAttempt(t, txStore, 777, 1, fromAddress)
...
func TestORM_FindEarliestUnconfirmedBroadcastTime(t *testing.T) {
	...
	t.Run("verify broadcast time", func(t *testing.T) {
		tx := testutils.MustInsertUnconfirmedEthTx(t, txStore, 123, fromAddress)
		broadcastAt, err := txStore.FindEarliestUnconfirmedBroadcastTime(tests.Context(t), ethClient.ConfiguredChainID())
		require.NoError(t, err)
...
func TestORM_SaveInProgressAttempt(t *testing.T) {
	...
	t.Run("saves new in_progress attempt if attempt is new", func(t *testing.T) {
		etx := testutils.MustInsertUnconfirmedEthTx(t, txStore, 1, fromAddress)

		attempt := testutils.NewLegacyEthTxAttempt(t, etx.ID)
...
func TestEthConfirmer_FindTxsRequiringResubmissionDueToInsufficientEth(t *testing.T) {
	...
	etx3 := testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 2, fromAddress)
	attempt3_2 := testutils.NewLegacyEthTxAttempt(t, etx3.ID)
	...
	testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 3, fromAddress)
	testutils.MustInsertConfirmedEthTxWithLegacyAttempt(t, txStore, 4, 100, fromAddress)
...
func TestORM_LoadEthTxesAttempts(t *testing.T) {
	...
	t.Run("load new attempt inserted in current postgres transaction", func(t *testing.T) {
		...
		newAttempt := testutils.NewDynamicFeeEthTxAttempt(t, etx.ID)
...
func TestORM_UpdateTxUnstartedToInProgress(t *testing.T) {
	...
	t.Run("update replaces abandoned tx with same hash", func(t *testing.T) {
		...
		etx2.Sequence = &nonce
		attempt2 := testutils.NewLegacyEthTxAttempt(t, etx2.ID)
	...
	t.Run("duplicate tx hash disallowed in tx_eth_attempts", func(t *testing.T) {
		...
		txStore = testutils.NewTestTxStore(t, db) // current txStore is poisened now, next test will need fresh one
	})
}
...
func TestORM_CountUnconfirmedTransactions(t *testing.T) {
	...
	testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 0, otherAddress)
	testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 0, fromAddress)
	testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 1, fromAddress)
	testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 2, fromAddress)
...
func TestORM_CountTransactionsByState(t *testing.T) {
	...
	testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 0, fromAddress1)
	testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 1, fromAddress2)
	testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, 2, fromAddress3)
...
func TestORM_CheckTxQueueCapacity(t *testing.T) {
	...
	n++
	testutils.MustInsertUnconfirmedEthTxWithBroadcastLegacyAttempt(t, txStore, n, fromAddress)
	n++
	...
	// deliberately one extra to exceed limit
	for i := 0; i <= int(maxUnconfirmedTransactions); i++ {
		testutils.MustInsertConfirmedEthTxWithLegacyAttempt(t, txStore, n, 42, fromAddress)
		n++
	}
...
func TestORM_CreateTransaction(t *testing.T) {
	...
	t.Run("sets signal callback flag", func(t *testing.T) {
		...
		testutils.AssertCount(t, db, "evm.txes", 3)
...
func TestORM_FindTxesWithAttemptsAndReceiptsByIdsAndState(t *testing.T) {
	...
	tx := testutils.MustInsertConfirmedEthTxWithLegacyAttempt(t, txStore, 0, 1, fromAddress)
...
func mustInsertTerminallyStuckTxWithAttempt(t testing.TB, txStore txmgr.TestEvmTxStore, fromAddress common.Address, nonceInt int64, broadcastBeforeBlockNum int64) txmgr.Tx {
	...
	attempt := testutils.NewLegacyEthTxAttempt(t, tx.ID)
