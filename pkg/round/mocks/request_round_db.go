...
import (
	...
	round "github.com/smartcontractkit/chainlink-evm/pkg/round"
...
func (_m *RequestRoundDB) WithDataSource(_a0 sqlutil.DataSource) round.RequestRoundDB {
	ret := _m.Called(_a0)
	...
	var r0 round.RequestRoundDB
	if rf, ok := ret.Get(0).(func(sqlutil.DataSource) round.RequestRoundDB); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(round.RequestRoundDB)
		}
	}
...
func (_c *RequestRoundDB_WithDataSource_Call) Return(_a0 round.RequestRoundDB) *RequestRoundDB_WithDataSource_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *RequestRoundDB_WithDataSource_Call) RunAndReturn(run func(sqlutil.DataSource) round.RequestRoundDB) *RequestRoundDB_WithDataSource_Call {
	_c.Call.Return(run)
	return _c
}
