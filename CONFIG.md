...
```
WriteCapability configures how the node configures the write capability
If this section is empty, the node will not have write capability
If it is set, the node will have write capability locally
Exposing the capability to external systems requires additional configuration in the capability registry contract
