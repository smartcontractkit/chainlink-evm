...
//go:generate go run ../generation/wrap.go ccip TokenPoolFactory token_pool_factory latest
//go:generate go run ../generation/wrap.go ccip FactoryBurnMintERC20 factory_burn_mint_erc20 latest
