...
func (_ChannelConfigStore *ChannelConfigStoreFilterer) FilterChannelDefinitionAdded(opts *bind.FilterOpts, donId []*big.Int) (*ChannelConfigStoreChannelDefinitionAddedIterator, error) {
	...
	logs, sub, err := _ChannelConfigStore.contract.FilterLogs(opts, "ChannelDefinitionAdded", donIdRule)
	if err != nil {
		return nil, err
	}
...
func (_ChannelConfigStore *ChannelConfigStoreFilterer) WatchChannelDefinitionAdded(opts *bind.WatchOpts, sink chan<- *ChannelConfigStoreChannelDefinitionAdded, donId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _ChannelConfigStore.contract.WatchLogs(opts, "ChannelDefinitionAdded", donIdRule)
	if err != nil {
		return nil, err
	}
...
type ChannelConfigStoreInterface interface {
	...
	FilterChannelDefinitionAdded(opts *bind.FilterOpts, donId []*big.Int) (*ChannelConfigStoreChannelDefinitionAddedIterator, error)

	WatchChannelDefinitionAdded(opts *bind.WatchOpts, sink chan<- *ChannelConfigStoreChannelDefinitionAdded, donId []*big.Int) (event.Subscription, error)
