...
func DeployPlaceholderContractNameZk(deployOpts *accounts.TransactOpts, client *clients.Client, wallet *accounts.Wallet, backend bind.ContractBackend, args ...any) (common.Address, *types.Receipt, *PlaceholderContractName, error) {
	var calldata []byte
	if len(args) > 0 {
